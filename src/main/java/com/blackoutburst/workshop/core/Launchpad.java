...
public class Launchpad {
    ...
    private static void redstonePad(Player player, WSPlayer qp, World world) {
    ...
    private static void lapisPad(Player player, WSPlayer qp, World world) {
        qp.setJumpPadCooldown(1);
        Vector dash = player.getLocation().getDirection().clone();
        world.playSound(player.getLocation(), Sound.PISTON_EXTEND, 4, 0.5f);
    ...
    public static void walkOn(PlayerMoveEvent event, WSPlayer qp) {
